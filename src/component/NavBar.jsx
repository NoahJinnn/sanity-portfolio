    ...
    <header className="nav-black-bg" style={{ fontSize: '0.8rem' }}>
      <div className="container mx-auto flex justify-between">
        ...
        <div className="text-gray-200 cursor-pointer inline-flex px-3 py-3 my-6 flex items-center">
          <span className={`mr-3 hover:text-yellow-200 ${lang === 'en' ? 'font-bold' : null}`} onClick={changeLang('en')}>
            English
          </span>
          <span className={`hover:text-yellow-200 ${lang === 'vi' ? 'font-bold' : null}`} onClick={changeLang('vi')}>
            Tiếng Việt
          </span>
          <NavMenu />
        </div>
